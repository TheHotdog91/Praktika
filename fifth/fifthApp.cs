...
class Program
{
    static void Main()
    {
        ...
        if (IsValidInput(input))
        {
            ...
            Tuple<string, Dictionary<char, int>, string> result = ProcessString(input, choice);
    ...
    static Tuple<string, Dictionary<char, int>, string> ProcessString(string input, int sortChoice)
    {
        ...
        if (input.Length % 2 == 0)
        {
            ...
            return Tuple.Create(sortedResult, charCount, longestVowelSubstring);
        }
        else
        {
